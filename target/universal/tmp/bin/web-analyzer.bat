@REM web-analyzer launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM WEB_ANALYZER_config.txt found in the WEB_ANALYZER_HOME.
@setlocal enabledelayedexpansion

@echo off

if "%WEB_ANALYZER_HOME%"=="" set "WEB_ANALYZER_HOME=%~dp0\\.."

set "APP_LIB_DIR=%WEB_ANALYZER_HOME%\lib\"
...
set "CFG_FILE=%WEB_ANALYZER_HOME%\WEB_ANALYZER_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running web-analyzer.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !WEB_ANALYZER_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
